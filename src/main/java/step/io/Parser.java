...
public class Parser {
  public Command parse(String origin) {
    ...
    else if ("2".equals(origin)) return Command.TIMETABLE_SHOWBYFLIGHT;
    else if ("3".equals(origin)) return Command.BOOKING_ADD;
    else if ("4".equals(origin)) return Command.BOOKING_REMOVE;
    else if ("5".equals(origin)) return Command.BOOKING_MYFLIGHT;
    else if ("EXIT".equalsIgnoreCase(origin)||"6".equalsIgnoreCase(origin)) return Command.EXIT;
